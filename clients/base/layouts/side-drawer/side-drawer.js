...
({
    ...
    _initDrawerConfigs: function() {
        if (app.lang.direction === 'rtl') {
            let tempLeft = this.drawerConfigs.left;
            this.drawerConfigs.left = this.drawerConfigs.right;
            this.drawerConfigs.right = tempLeft;
        }
