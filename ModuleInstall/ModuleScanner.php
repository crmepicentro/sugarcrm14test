...
use Sugarcrm\Sugarcrm\FeatureToggle\Features\SecureSmarty;
...
class ModuleScanner
{
    ...
    public function __construct()
    {
        ...
        if ($features->isEnabled(SecureSmarty::getName())) {
            $classesBlackList = array_merge($classesBlackList, ['smarty', 'sugar_smarty', 'sugarpdfsmarty',]);
        }
