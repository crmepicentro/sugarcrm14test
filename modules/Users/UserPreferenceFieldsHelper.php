...
class UserPreferenceFieldsHelper
{
    ...
    {
        $pref = $user->getPreference('sugarpdf_pdf_font_name_main');
        if (empty($pref)) {
            include_once 'include/Sugarpdf/sugarpdf_config.php';
            $pref = PDF_FONT_NAME_MAIN;
        }
    ...
    {
        $pref = $user->getPreference('sugarpdf_pdf_font_size_main');
        if (empty($pref)) {
            include_once 'include/Sugarpdf/sugarpdf_config.php';
            $pref = PDF_FONT_SIZE_MAIN;
        }
    ...
    {
        $pref = $user->getPreference('sugarpdf_pdf_font_name_data');
        if (empty($pref)) {
            include_once 'include/Sugarpdf/sugarpdf_config.php';
            $pref = PDF_FONT_NAME_DATA;
        }
    ...
    {
        $pref = $user->getPreference('sugarpdf_pdf_font_size_data');
        if (empty($pref)) {
            include_once 'include/Sugarpdf/sugarpdf_config.php';
            $pref = PDF_FONT_SIZE_DATA;
        }
